...
CREATE UNIQUE INDEX idx_categorie_libelle ON categorie (Libelle ASC);
...
CREATE UNIQUE INDEX idxauteur_nom ON auteur (Nom ASC);
...
CREATE UNIQUE INDEX idxediteur_nom ON editeur (Nom ASC);
